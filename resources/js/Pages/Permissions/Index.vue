<template>
    <jetin-layout :title="__('Permission')">
            ...
            <div class="z-10 flex-auto bg-white md:rounded-md md:shadow-md w-full">
                ...
                <jet-confirmation-modal title="Confirm Deletion" :show="confirmDelete">
                    ...
                    <template v-slot:footer>
                        <div class="flex justify-end gap-x-2">
                            <inertia-button as="button" type="button" @click.native.stop="cancelDelete" class="bg-orange-500 text-white">Cancel</inertia-button>
                            <inertia-button as="button" type="button" @click.native.prevent="deleteModel" class="bg-blue-500 text-white">Yes, Delete</inertia-button>
                        </div>
                    </template>
                ...
                <div v-if="showModal && currentModel">
                    <jetin-modal
                        ...
                        <template #title>Show Permission - {{currentModel.title}}</template>
        ...
        <div v-else class="p-4 font-bold text-red-500 bg-red-100 rounded-md shadow-md ">
            You are not authorized to view a list of {{__("Permissions")}}
        </div>
    </jetin-layout>
</template>

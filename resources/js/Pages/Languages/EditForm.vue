<template>
    <form @submit.prevent="updateModel">
                ...
                <jet-input class="w-full"  v-if="form.id!=1" type="text" id="code" name="code" v-model="form.code"
                    :class="{'border-red-500 sm:focus:border-red-300 sm:focus:ring-red-100': form.errors.code}"
                ></jet-input>
                <jet-input class="w-full" v-if="form.id==1" type="text" disabled="disabled" v-model="form.code"
                    :class="{'border-red-500 sm:focus:border-red-300 sm:focus:ring-red-100': form.errors.code}"
                ></jet-input>
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            async updateModel() {
                this.form.put(this.route('admin.languages.update',this.form.slug),
                    {
                        onSuccess: res => {

<template>
    <jetin-layout :title="__('Details of') + '-' + __('Product Type')">
        <template #navbar-button>
            ...
            >
                ...
                ><i class="fas fa-arrow-left"></i> {{__('Back')}} | {{__('Details of')}} {{__("Product Type")}}
        ...
        <div v-if="model.can.view" class="flex flex-wrap px-4">
            ...
            >
                <show-product-types-form :model="model"></show-product-types-form>
            </div>
        </div>
...
<script>
    ...
    import ShowProductTypesForm from "./ShowForm.vue"

        ...
        >
          ...
          <div class="sm:col-span-4">
            ...
            <jet-input
              ...
              id="name"
              name="name"
              v-model="form_attributes.name"
              :class="{
                'border-red-500 sm:focus:border-red-300 sm:focus:ring-red-100':
                  form.errors['form_attributes.' + index + '.name'],
              }"
            ></jet-input>
            <jet-input-error
              :message="form.errors['form_attributes.' + index + '.name']"
              class="mt-2"
            />
          </div>
          ...
          <div class="sm:col-span-4">
            ...
            <jet-input
              ...
              id="phone"
              name="phone"
              v-model="form_attributes.phone"
              :class="{
                'border-red-500 sm:focus:border-red-300 sm:focus:ring-red-100':
                  form.errors['form_attributes.' + index + '.phone'],
              }"
            ></jet-input>
            <jet-input-error
              :message="form.errors['form_attributes.' + index + '.phone']"
              class="mt-2"
            />
          </div>
          ...
          <div class="sm:col-span-4">
            ...
            <jet-input
              ...
              id="email"
              name="email"
              v-model="form_attributes.email"
              :class="{
                'border-red-500 sm:focus:border-red-300 sm:focus:ring-red-100':
                  form.errors['form_attributes.' + index + '.email'],
              }"
            ></jet-input>
            <jet-input-error
              :message="form.errors['form_attributes.' + index + '.email']"
              class="mt-2"
            />
          </div>

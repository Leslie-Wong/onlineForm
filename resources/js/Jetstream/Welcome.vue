<template>
    <div>
        <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
            ...
            <jetin-tabs>
                <template #nav>
                    <jetin-tab-link @activate="activateTab" :active-classes="activeTabLinkClasses" tab="info" :tab-controller="activeTab">@{{__("Basic Info")}}rmation</jetin-tab-link>
                    <jetin-tab-link @activate="activateTab" :active-classes="activeTabLinkClasses" tab="more-details" :tab-controller="activeTab"> More Details</jetin-tab-link>
                </template>
                <template #content>
                    <jetin-tab name="info" :tab-controller="activeTab">@{{__("Basic Info")}} goes here</jetin-tab>
                    <jetin-tab name="more-details" :tab-controller="activeTab">More Info Goes Here</jetin-tab>
                </template>
            </jetin-tabs>

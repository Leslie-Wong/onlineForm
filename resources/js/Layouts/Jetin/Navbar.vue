<template>
    <!-- Navbar -->
    <nav class="top-0 z-20 w-full bg-primary md:-top-0 navbar">
        ...
        <div class="pr-4 mx-auto sm:pr-6 lg:pr-8">
            ...
            <div class="flex w-full justify-between h-16">
                ...
                <!-- Hamburger -->
                <div class="hidden flex items-center -mr-2 sm:hidden">
                    <button
                        @click="
...
import ResponsiveNavLink from "@/JetinComponents/ResponsiveNavLink.vue";
import JetResponsiveNavLink from "@/Jetstream/ResponsiveNavLink.vue";
import SystemNotificationsDropdown from "@/JetinComponents/SystemNotificationsDropdown.vue";
...
export default defineComponent({
    ...
    methods: {
        async fetchUnreadNotifications() {
            await axios.get(this.route("api.me.notifications.unread.fetch")).then((res) => {
                this.unreadNotifications = res.data.payload;

        ...
        >
            ...
            >
                <svg viewBox="0 0 100 80" width="40" height="40">
                    <rect fill="#222" width="100" height="5"></rect>
                    <rect fill="#222" y="20" width="80" height="5"></rect>
                    <rect fill="#222" y="40" width="70" height="5"></rect>
                    <rect fill="#222" y="60" width="90" height="5"></rect>
                </svg>
            </button>
            <!-- Brand -->
            <inertia-link
            ...
            >
                ...
                <ul class="flex flex-col list-none md:flex-col md:min-w-full">
                    <li v-for="(menuItem, idx) of menuItems" :key="idx" class="items-center">
                        ...
                        ></i>
                            <span class="hover:visible">{{__(menuItem.title)}}</span></sidebar-link
                        >
                        <jetin-sidebar-link
                        ...
                        >
                            <div class="text-md">
                                ...
                                <span class="hover:visible" :class="{'invisible': minimized}">{{ __(menuItem.title) }}</span>
                            </div>
...
import SidebarLink from "@/JetinComponents/SidebarLink.vue";
import JetinSidebarLink from "@/JetinComponents/JetinSidebarLink.vue";
import ApplicationMark from "@/JetinComponents/ApplicationMark.vue";
...
.text-2xl.font-semibold{
    text-shadow: 0px 0px 5px #4e5054;
}
</style>

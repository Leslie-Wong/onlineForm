...
class FillPermissionsForLanguages extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLanguages constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                ...
                'List All Languages' => 'languages.index',
                'Create New Languages' => 'languages.create',
                'View Any Language' => 'languages.show',
                'Edit or Update a Single Language' => 'languages.edit',
                'Delete Languages' => 'languages.delete',
            ]);

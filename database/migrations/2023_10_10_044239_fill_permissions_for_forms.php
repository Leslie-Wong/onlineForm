...
class FillPermissionsForForms extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForForms constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                'Forms Module' => 'forms',
                'List All Forms' => 'forms.index',
                'Create New Forms' => 'forms.create',
                'View Any Form' => 'forms.show',
                'Edit or Update a Single Form' => 'forms.edit',

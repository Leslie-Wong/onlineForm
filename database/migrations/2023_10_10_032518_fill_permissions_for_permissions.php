...
class FillPermissionsForPermissions extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPermissions constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                ...
                'List All Permissions' => 'permissions.index',
                'Create New Permissions' => 'permissions.create',
                'View Any Permission' => 'permissions.show',
                'Edit or Update a Single Permission' => 'permissions.edit',

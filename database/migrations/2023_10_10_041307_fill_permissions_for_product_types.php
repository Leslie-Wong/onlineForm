...
class FillPermissionsForProductTypes extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProductTypes constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                ...
                'List All Product Types' => 'product-types.index',
                'Create New Product Types' => 'product-types.create',
                'View Any Product Type' => 'product-types.show',
                'Edit or Update a Single Product Type' => 'product-types.edit',
                'Delete Product Types' => 'product-types.delete',
            ]);

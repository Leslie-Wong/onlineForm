...
class FillPermissionsForAdmins extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAdmins constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                'Admin Module' => 'admins',
                'List All Admin' => 'admins.index',
                'Create New Admin' => 'admins.create',
                'View Any Admin' => 'admins.show',
                'Edit or Update a Single Admin' => 'admins.edit',

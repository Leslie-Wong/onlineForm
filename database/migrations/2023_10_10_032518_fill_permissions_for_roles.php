...
class FillPermissionsForRoles extends Migration
{
    ...
    /**
     * FillPermissionsForRoles constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                'Roles Module' => 'roles',
                'List All Roles' => 'roles.index',
                'Create New Roles' => 'roles.create',
                'View Any Role' => 'roles.show',
                'Edit or Update a Single Role' => 'roles.edit',

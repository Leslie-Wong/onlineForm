...
class FillPermissionsForFormAttributes extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFormAttributes constructor.
     */
    public function __construct()
    {
        ...
        foreach ($this->guardName as $guardName) {
            $permissions = collect([
                'Form Attributes Module' => 'form-attributes',
                'List All Form Attributes' => 'form-attributes.index',
                'Create New Form Attributes' => 'form-attributes.create',
                'View Any Form Attribute' => 'form-attributes.show',
                'Edit or Update a Single Form Attribute' => 'form-attributes.edit',
                'Delete Form Attributes' => 'form-attributes.delete',
            ]);

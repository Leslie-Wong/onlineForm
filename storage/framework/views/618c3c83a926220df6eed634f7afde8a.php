    ...
    <?php $hasSelect = true; ?>
        <div class=" sm:col-span-4">
            ...
            <infinite-select :per-page="15"
                             ...
                             return-object
                             variant="solo"
                             <?php echo e(isset($belongsTo['multiple'])?$belongsTo['multiple']:""); ?>
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/user/create-form.blade.php ENDPATH**/ ?>
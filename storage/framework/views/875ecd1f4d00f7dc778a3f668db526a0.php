...
class <?php echo e($controllerBaseName); ?>  extends Controller
{
     ...
     * <?php echo e("@"); ?>return columnsToQuery \Illuminate\Http\JsonResponse
     */
    ...
    public function store(Store<?php echo e($modelBaseName); ?> $request)
    {
        try {
            ...
            return $this->api->success()->message('<?php echo e($modelTitle); ?> Created')->payload($<?php echo e($modelVariableName); ?>)->send();
    ...
    public function show(Request $request, <?php echo e($modelBaseName); ?> $<?php echo e($modelVariableName); ?>)
    {
        try {
            ...
            $payload->load([
<?php $__currentLoopData = $relations['hasMany']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $hasMany): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                '<?php echo e($key); ?>',
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ]);
<?php endif; ?>
            ...
            return $this->api->success()
                    ->message("<?php echo e($modelTitle); ?> $<?php echo e($modelVariableName); ?>->id")
    ...
    public function update(Update<?php echo e($modelBaseName); ?> $request, <?php echo e($modelBaseName); ?> $<?php echo e($modelVariableName); ?>)
    {
        try {
            ...
            return $this->api->success()->message("<?php echo e($modelTitle); ?> has been updated")->payload($res)->code(200)->send();
        } catch (\Throwable $exception) {
            \Log::error($exception);
    ...
    public function destroy(Destroy<?php echo e($modelBaseName); ?> $request, <?php echo e($modelBaseName); ?> $<?php echo e($modelVariableName); ?>)
    {
        ...
        return $this->api->success()->message("<?php echo e($modelTitle); ?> has been deleted")->payload($res)->code(200)->send();
    }
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/withChildren/api-controller.blade.php ENDPATH**/ ?>
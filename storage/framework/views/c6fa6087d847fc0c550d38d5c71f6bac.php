<template>
    <jetin-layout :title="<?php echo '__(\'' . $modelTitle. '\')'; ?>">
            ...
            <div class="z-10 flex-auto bg-white md:rounded-md md:shadow-md w-full">
                ...
                <jet-confirmation-modal title="Confirm Deletion" :show="confirmDelete">
                    <template v-slot:content>
                        <div><?php echo e(__('Are you sure you want to delete this record?')); ?></div>
                    </template>
                    <template v-slot:footer>
                        <div class="flex justify-end gap-x-2">
                            <inertia-button as="button" type="button" @click.native.stop="cancelDelete" class="bg-orange-500 text-white"><?php echo e(__('Cancel')); ?></inertia-button>
                            <inertia-button as="button" type="button" @click.native.prevent="deleteModel" class="bg-blue-500 text-white"><?php echo e(__('Yes, Delete')); ?></inertia-button>
                        </div>
                    </template>
                ...
                <div v-if="showModal && currentModel">
                    <jetin-modal
                        ...
                        <template <?php echo e('#'); ?><?php echo e('title'); ?>><?php echo e(__('Show')); ?> <?php echo e(__($modelTitle)); ?> - <?php echo e('{{'); ?>currentModel.title}}</template>
                        ...
                        <template <?php echo e('#'); ?><?php echo e('footer'); ?>>
                            <inertia-button class="px-4 text-white bg-primary" <?php echo e('@'); ?>click="showModal = false; currentModel = null"><?php echo e(__('Close')); ?></inertia-button>
                        </template>
                    </jetin-modal>
                </div>
            </div>
        ...
        <div v-else class="p-4 font-bold text-red-500 bg-red-100 rounded-md shadow-md ">
            <?php echo e(__('You are not authorized to view a list of')); ?> <?php echo '{{__("' . $modelTitlePlural. '")}}'; ?>
...
<script>
    ...
    export default {
        name: "<?php echo e($modelPlural); ?>Index",
        components: {
            DtComponent,
            JetinToggle,
            InertiaButton,
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/permission/index.blade.php ENDPATH**/ ?>
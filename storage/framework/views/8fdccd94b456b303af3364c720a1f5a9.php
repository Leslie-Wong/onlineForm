...
<?php if(strpos(strtolower($column['name']), "file") !== false): ?>
            '<?php echo e($column['name']); ?>' => [<?php echo $column['serverUpdateRules'][0]; ?>, 'max:'.\Config::get('jetin.maxUpload', 10000)],
<?php elseif(!($column['name'] == "updated_by_admin_user_id" || $column['name'] == "created_by_admin_user_id" )): ?>'<?php echo e($column['name']); ?>' => [<?php echo implode(', ', (array) $column['serverUpdateRules']); ?>],
<?php endif; ?>
...
}<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/update-request.blade.php ENDPATH**/ ?>
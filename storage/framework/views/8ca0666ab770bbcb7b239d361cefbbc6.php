            ...
            <div class="z-10 flex-auto bg-white md:rounded-md md:shadow-md w-full">
                ...
                <div v-if="showModal && currentModel">
                    <jetin-modal
                        ...
                        <template <?php echo e('#'); ?><?php echo e('title'); ?>>{{__('Show')}} <?php echo '{{__("' .$modelTitle. '")}}'; ?> - <?php echo e('{{'); ?>currentModel.name}}</template>
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/language/index.blade.php ENDPATH**/ ?>
...
class <?php echo e($controllerBaseName); ?>  extends Controller
{
    ...
    public function show(Request $request, <?php echo e($modelBaseName); ?> $<?php echo e($modelVariableName); ?>)
    {
        try {
            ...
            return $this->api->success()
                        ->message("<?php echo '{{__(\'' . $modelTitle. '\')}}'; ?> $<?php echo e($modelVariableName); ?>->id")
    ...
    public function update(Update<?php echo e($modelBaseName); ?> $request, <?php echo e($modelBaseName); ?> $<?php echo e($modelVariableName); ?>)
    {
        try {
            ...
            return $this->api->success()->message("<?php echo '{{__(\'' . $modelTitle. '\')}}'; ?> {{__('has been updated')}}")->payload($res)->code(200)->send();
        } catch (\Throwable $exception) {
            \Log::error($exception);
    ...
    public function destroy(Destroy<?php echo e($modelBaseName); ?> $request, <?php echo e($modelBaseName); ?> $<?php echo e($modelVariableName); ?>)
    {
        ...
        return $this->api->success()->message("<?php echo '{{__(\'' . $modelTitle. '\')}}'; ?> {{__('has been deleted')}}")->payload($res)->code(200)->send();
    }
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/language/api-controller.blade.php ENDPATH**/ ?>
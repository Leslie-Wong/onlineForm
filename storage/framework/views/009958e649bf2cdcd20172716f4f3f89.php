...
class Update<?php echo e($modelBaseName); ?> extends FormRequest
{
    ...
    {
<?php $__currentLoopData = $childrenColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php elseif(!($column['name'] == "updated_by_admin_user_id" || $column['name'] == "created_by_admin_user_id" )): ?> <?php echo PHP_EOL ?>
            '<?php echo e($column['name']); ?>' => [<?php echo implode(', ', (array) $column['serverUpdateRules']); ?>],
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if(isset($childrenColumns) && count($childrenColumns)): ?>
                    <?php $__currentLoopData = $childrenColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $children): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo PHP_EOL ?>
            '<?php echo e(Str::plural($key)); ?>' => ['sometimes','array'],
<?php $__currentLoopData = $children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childColumn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php elseif($childColumn['name'] == "id"): ?> <?php echo PHP_EOL ?>
            '<?php echo e(Str::plural($key)); ?>.*.id' => ['sometimes', 'string'],
<?php elseif(!($childColumn['name'] == "updated_by_admin_user_id" || $childColumn['name'] == "created_by_admin_user_id" )): ?> <?php echo PHP_EOL ?>
            '<?php echo e(Str::plural($key)); ?>.*.<?php echo e($childColumn['name']); ?>' => [<?php echo implode(', ', (array) $childColumn['serverUpdateRules']); ?>],
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/withChildren/update-request.blade.php ENDPATH**/ ?>
...
<?php Lesliew\LaravelJetinGenerator\Generators\ColumnTransition::addTransitionText($belongsTo['related_model_title']) ?>
            <jet-label for="<?php echo e($belongsTo['function_name']); ?>" :value="__('<?php echo e($belongsTo['related_model_title']); ?>')" />
            <infinite-select :per-page="15"
...
<?php endif; ?>
    ...
    export default defineComponent({
        ...
        components: {
            ...
            <?php if($hasMultiSelect): ?>LesMultiSelect,<?php echo e("\r"); ?><?php endif; ?>
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/create-form.blade.php ENDPATH**/ ?>
...

{
    ...
    {
        return $user->hasPermissionTo('<?php echo e($modelDotNotation); ?>.delete') && $<?php echo e($modelVariableName); ?>->name !== 'administrator';
    }
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/role/policy.blade.php ENDPATH**/ ?>
        ...
        <template <?php echo e('#'); ?>navbar-button>
            <div class="flex flex-wrap items-center justify-between w-full px-4">
                <inertia-link :href="route('admin.<?php echo e($modelRouteAndViewName); ?>.index')" class="text-xl font-black text-zinc-400"><i class="fas fa-arrow-left"></i> {{__('Back')}} | {{__('Edit')}}
                    <?php echo '{{__("' . $modelTitle. '")}}'; ?> - {{model.name}}</inertia-link>
            </div>
        </template>
        <div class="flex flex-wrap px-4">
            <div class="z-10 flex-auto max-w-5xl p-4 mx-auto bg-white md:rounded-md md:shadow-md">
                <edit-<?php echo e($modelRouteAndViewName); ?>-form :permissions="permissions" :model="model" <?php echo e('@'); ?>success="onSuccess" <?php echo e('@'); ?>error="onError"/>
            </div>
        </div>
    </jetin-layout>
</template>
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/role/edit.blade.php ENDPATH**/ ?>
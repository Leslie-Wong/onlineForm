            ...
            <div class=" sm:col-span-4 children-table shadow-sm border-gray-100">
                ...
                <div id="<?php echo e($key); ?>" v-for="(<?php echo e($key); ?>, index) in form.<?php echo e($key); ?>" :key="index">
                    <div :class="['children-row', (index!=0?'children-row-n':''),(index%2!=0?'children-row-even':'')]">
                        <div  v-if="index != 0" id="delete-child" @click="confirmDeletion(Object.assign({'index':index, 'modelName':'<?php echo e($key); ?>'}, <?php echo e($key); ?>))">
...
<?php
$val = ':false,';
if($childColumns['default'])
    $val = ':"'.$childColumns['default'].'",';
$children[$key][] = $childKey.$val; ?>
<?php else: ?>
<?php
$val = ':null,';
if($childColumns['default'])
...
<?php Lesliew\LaravelJetinGenerator\Generators\ColumnTransition::addTransitionText($belongsTo['related_model_title']) ?>
        <div class=" sm:col-span-4 belongsTo">
...
<?php endif; ?>
        ...
        <div class="mt-2 text-right text-white">
            <inertia-button type="submit" class="font-semibold bg-success disabled:opacity-25 bg-gray-400" :disabled="form.processing">{{__("Submit")}}</inertia-button>
        </div>
    </form>
...
<?php if(!isset($col['type']) && gettype($col) === "object"): ?>
                <?php echo e($key); ?>: [{
<?php $__currentLoopData = $children[$key]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $childrenKey => $childrenVal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $childrenVal; ?>

<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                }],
<?php else: ?>
<?php if($model->initData->hasCheckbox): ?>
                <?php echo e($key); ?>:  <?php if($col['default']): ?> "<?php echo $col['default']; ?>"<?php else: ?> false <?php endif; ?>,
<?php else: ?>
                <?php echo e($key); ?>: <?php if($col['default']): ?> "<?php echo $col['default']; ?>"<?php else: ?> null <?php endif; ?>,
<?php endif; ?>
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php if(count($relations)): ?>
...
<?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php if(!isset($col['type']) && gettype($col) === "object"): ?>
            formData.errors.<?php echo e($key); ?> = {};
<?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            return {
                confirmDelete: false,
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/withChildren/create-form.blade.php ENDPATH**/ ?>
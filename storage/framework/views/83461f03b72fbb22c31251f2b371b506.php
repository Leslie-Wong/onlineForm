...
<?php if(isset($relations['hasMany']) && count($relations['hasMany'])): ?>
    ...
    */
    ...
    {
        $modelNamespace = "<?php echo e($modelNamespace); ?>\\";
...
<?php if(isset($rootOptions) && in_array('pdfview', $rootOptions)): ?>
    public function pdfView(Request $request, Quotation $quotation){

        dd("Set your PDF View Here. Return a HTML Code.");

    }
<?php endif; ?>
}
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/withChildren/controller.blade.php ENDPATH**/ ?>
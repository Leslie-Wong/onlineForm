        ...
        <template <?php echo e('#'); ?>navbar-button>
            <div class="flex flex-wrap items-center justify-between w-full px-4">
                <inertia-link :href="route('admin.<?php echo e($modelRouteAndViewName); ?>.index')"
                        ...
                        class="fas fa-arrow-left"></i> {{__('Back')}} | {{__('New')}} <?php echo e(__($modelTitle)); ?>
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/user/create.blade.php ENDPATH**/ ?>
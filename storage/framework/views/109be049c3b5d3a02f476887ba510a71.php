...
class <?php echo e($modelBaseName); ?> extends Authenticatable
{
...
<?php if($fillable): ?>
    ...
    */
    protected $casts = [
        ...
        <?php if($booleans && count($booleans) > 0): ?>
<?php $__currentLoopData = $booleans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>'<?php echo e($b); ?>' => 'boolean',<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
    ];
...
<?php endif; ?>
<?php endif; ?>}
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/user/model.blade.php ENDPATH**/ ?>
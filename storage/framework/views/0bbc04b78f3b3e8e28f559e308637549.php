...
<?php endif; ?>
            <?php endif; ?>
            $permissions = Permission::where("guard_name",$<?php echo e($modelVariableName); ?>->guard_name)->get()->map(function($perm) use($role) {
...
<?php /**PATH /var/www/online_form/vendor/lesliew/laravel-jetin-generator/src/../resources/views/templates/role/controller.blade.php ENDPATH**/ ?>